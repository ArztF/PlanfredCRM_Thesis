...
\newpage
\begin{lstlisting}[caption=Composition-API Beispiel]
...
\end{lstlisting}
\newline
\begin{lstlisting}[caption=Options-API Beispiel]
    export default {
      data() {
        return {
          count: 0
...
\newpage
\begin{lstlisting}[language=html, caption=VueJS Reactivity Beispiel]
    <script>
    export default {
      data() {
        return {
...
\begin{lstlisting}[caption=beforeCreate Hook]
    <script>
    export default {
    	beforeCreate() {
...
\begin{lstlisting}[caption=created Hook]
    <script>
    export default {
      data() {
        return {
...
\begin{lstlisting}[language=html, caption=beforeMount Hook]
    <script>
    export default {
      beforeMount() {
...
\begin{lstlisting}[caption=mounted Hook]
    <template>
...
\begin{lstlisting}[caption=beforeUpdate Hook]
    <template>
...
\begin{lstlisting}[caption=updated Hook]
    <template>
      <div ref="example-element">{{counter}}</div>
    </template>
...
\begin{lstlisting}[caption=beforeDestroy Hook]
    <script>
    export default {
      data() {
        return {
...
\begin{lstlisting}[caption=destroyed Hook]
    <script>
...
Zu diesem Zeitpunkt wurde die Komponente schon vollständig abgebaut,  die Methode kann zum Beispiel verwendet werden um einen externen Services zu informieren, dass die Komponente zerstört wurde.\cite{frontend_web_vuejs_lifecycle}
