...
wird der Token validiert und überprüft ob dieser noch gültig ist. Wird hier ein Fehler ausgelöst, wird einfach in die nächste API Middleware weitergegangen. Ist dieser Vorgang erfolgreich, wird die Payload, also in diesem Fall die E-Mail Adresse zurückgeschickt.
